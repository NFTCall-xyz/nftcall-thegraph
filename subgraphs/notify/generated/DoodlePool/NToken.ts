...
export class NFTTransfered extends ethereum.Event {
  get params(): NFTTransfered__Params {
    return new NFTTransfered__Params(this);
  }
}

export class NFTTransfered__Params {
  _event: NFTTransfered;

  constructor(event: NFTTransfered) {
    this._event = event;
  }
...
export class NToken extends ethereum.SmartContract {
  static bind(address: Address): NToken {
    return new NToken("NToken", address);
  }
