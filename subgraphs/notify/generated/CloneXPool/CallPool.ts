...
export class CallPool extends ethereum.SmartContract {
  ...
  MAXIMUM_STRIKE_PRICE_IN_CONTRACT_DECIMALS(): BigInt {
    let result = super.call(
      "MAXIMUM_STRIKE_PRICE_IN_CONTRACT_DECIMALS",
      "MAXIMUM_STRIKE_PRICE_IN_CONTRACT_DECIMALS():(uint256)",
      []
    );
  ...
  try_MAXIMUM_STRIKE_PRICE_IN_CONTRACT_DECIMALS(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "MAXIMUM_STRIKE_PRICE_IN_CONTRACT_DECIMALS",
      "MAXIMUM_STRIKE_PRICE_IN_CONTRACT_DECIMALS():(uint256)",
      []
